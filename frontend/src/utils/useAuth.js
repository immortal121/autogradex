    ...
    if (userRole === null || userRole === undefined) {
      ...
      switch (userRole) {
        case '3': // Student
          ...
          break;
        case '2': // Teacher
          if (!router.pathname.startsWith('/teacher') && !router.pathname.startsWith('/digievaluator')) {
            router.push('/teacher');
          }
          break;
        case '1': // Admin
          if (!router.pathname.startsWith('/admin') && !router.pathname.startsWith('/digievaluator')) {
            router.push('/admin');
          }
          break;
        case '0': // Super Admin
